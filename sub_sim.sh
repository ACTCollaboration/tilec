...
# Baseline deep56 run with fgfit !!!!
mpi_niagara 8 "python bin/actsim.py sim_baseline deep56 d56_01,d56_02,d56_03,d56_04,d56_05,d56_06,p01,p02,p03,p04,p05,p06,p07,p08 CMB,tSZ,CMB-tSZ,CMB-CIB,tSZ-CMB,tSZ-CIB 1.6,1.6,2.4,2.4,2.4,2.4 --overwrite --nsims 80 --fg-res-version fgfit" -t 40 --walltime "10:00:00"
mpi_niagara 8 "python bin/actsim.py sim_baseline deep56 d56_01,d56_02,d56_03,d56_04,d56_05,d56_06,p01,p02,p03,p04,p05,p06,p07,p08 CMB,tSZ,CMB-tSZ,CMB-CIB,tSZ-CMB,tSZ-CIB 1.6,1.6,2.4,2.4,2.4,2.4 --overwrite --nsims 80 --start-index 80  --fg-res-version fgfit" -t 40 --walltime "10:00:00"
...
# 0 - 79
mpi_niagara 16 "python bin/actsim.py sim_baseline boss boss_01,boss_02,boss_03,boss_04,p01,p02,p03,p04,p05,p06,p07,p08 CMB,tSZ,CMB-tSZ,CMB-CIB,tSZ-CMB,tSZ-CIB 1.6,1.6,2.4,2.4,2.4,2.4 --overwrite --nsims 80 --fg-res-version fgfit" -t 80 --walltime "15:00:00"

# 80 - 159
mpi_niagara 16 "python bin/actsim.py sim_baseline boss boss_01,boss_02,boss_03,boss_04,p01,p02,p03,p04,p05,p06,p07,p08 CMB,tSZ,CMB-tSZ,CMB-CIB,tSZ-CMB,tSZ-CIB 1.6,1.6,2.4,2.4,2.4,2.4 --overwrite --nsims 80 --start-index 80 --fg-res-version fgfit" -t 80 --walltime "15:00:00"
